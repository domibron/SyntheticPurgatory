...
public class BarrelSpawner : MonoBehaviour
{
    ...
    /// </summary>
    [SerializeField]
    private GameObject[] barrelPrefabs;
    /// <summary>
    ...
    void Start()
    {
        ...
        GameObject newobject = Instantiate(barrelPrefabs[Random.Range(0, barrelPrefabs.Length - 1)], transform.position, transform.rotation, transform);
