...
/// <summary>
/// A stat that can be upgraded, this handles upgrading, scaling the upgrade amount and cost of the upgrade.
/// </summary>
[Serializable]
public class UpgradableStat : ICloneable
{
    ...
    public UpgradableStat(float baseVal) // If needed we can have a custom constructor for cloning.
    {
        BaseStat = baseVal;
